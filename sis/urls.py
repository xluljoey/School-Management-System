...
from .views import (
    ...
    midterm_generate_report_hub_view,
    midterm_print_report_cards_view,
    parents_list,
    parent_detail_view,
    parent_edit_view,
    export_students_excel,
    ...
    export_session_json,
    import_session_json,
    import_session_excel,
    assign_form_class,
    classes_subjects_hub,
    timetable_hub,
    timetable_create,
    timetable_detail_api,
    timetable_delete,
    generate_report_cards_view,
    print_report_cards_view,
    export_excel_view,
...
urlpatterns = [
    ...
    path('alumni/export/', export_alumni_excel, name='export_alumni_excel'),
    ...
    path('students/register/', student_registration_view, name='register_student'),    path('students/enroll/<int:student_id>/', enroll_student_view, name='enroll_student'),
    path('students/report/<int:class_id>/', class_report_card_view, name='class_report_card'),
    path('students/export/', export_students_excel, name='export_students_excel'),
    ...
    path('staff/export-excel/', export_staff_excel, name='export_staff_excel'),
    ...
    path('session/export/excel/', export_session_excel, name='export_session_excel'),
    path('session/export/json/', export_session_json, name='export_session_json'),
    path('session/import/json/', import_session_json, name='import_session_json'),
    path('session/import/excel/', import_session_excel, name='import_session_excel'),
    path('session/rollover/', academic_year_rollover_view, name='academic_year_rollover'),
    ...
    path('midterm/<int:class_id>/generate/', midterm_generate_report_hub_view, name='midterm_generate_report_hub'),
    path('midterm/<int:class_id>/print/', midterm_print_report_cards_view, name='midterm_print_report_cards'),
    path('parents/', parents_list, name='parents_list'),
    path('parents/export/', export_parents_excel, name='export_parents_excel'),
    ...
    path('timetables/create/', timetable_create, name='timetable_create'),
    path('timetables/<int:timetable_id>/detail/', timetable_detail_api, name='timetable_detail_api'),
    path('timetables/<int:timetable_id>/delete/', timetable_delete, name='timetable_delete'),
    ...
    path('class/<int:class_id>/report/print/', print_report_cards_view, name='print_report_cards'),
